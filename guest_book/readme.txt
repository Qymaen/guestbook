//Это тестовое задание для Junior PHP разработчика.
...
//Если необходимо, измените пароль и логин для входа в базу данных. Они заданы в том же файле "db.php"
//дамп базы данных в файле guest.sql